...
Aplikasi ujian online (CBT) dengan arsitektur serverless, fitur keamanan anti-curang, dan live score real-time ala CAT BKN.
...
2.  **Live Score Board:** Tampilan proyektor dengan animasi ranking & auto-scroll.
...
4.  **Complex Question Type:** Mendukung Pilihan Ganda & Pilihan Ganda Kompleks (Checkbox).

## 🚀 Getting Started

### 1. Setup Backend (Google Sheets & GAS)
1.  Buat Google Sheet baru dengan 4 Tab: `Config`, `Users`, `Questions`, `Responses`.
2.  Klik **Extensions > Apps Script**.
3.  Copy kode dari folder `/backend-script/code.gs` (Generate ini via AI sesuai PRD).
4.  **Deploy:**
